...
public class HomeFragment extends Fragment {
    ...
    public  HomeFragment(CallBackClickListener callBackClickListener, boolean isUserLoggedIn){
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.loginConstraintBtn)
                        .setVisibility((isUserLoggedIn ? View.INVISIBLE : View.VISIBLE));
        ...
        view.findViewById(R.id.loginConstraintBtn)
            ...
            public void onClick(View view) {
                if (callBackClickListener != null){
                    callBackClickListener.onNavigate();
                }
            }
        });
    }
