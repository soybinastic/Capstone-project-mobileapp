...
public class OnDecrementQuantity implements ICartProcessor{

    private CartItemModel cartItemModel;
    public OnDecrementQuantity(CartItemModel cartItemModel){
    ...
    public void onProcess(CartService cartService, Context context, Invoker<BaseModel, String> listener,
        ...
        Call<ServerResponse> result = cartService.decrementQuantity(cartItemModel.getHardwareStoreId(), cartItemModel.getCartId(),
            ...
            public void onResponse(Call<ServerResponse> call, Response<ServerResponse> response) {
                if (response.isSuccessful()){
                    listener.onClick(new ExecutedCartProcessResult(true, 1, cartItemModel.getProductPrice(),
                            cartItemModel.getProductName(), OnDecrementQuantity.this), "");
                }else {
